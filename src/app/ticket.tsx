...
import { View, StatusBar, Text, ScrollView, Touchable, TouchableOpacity, Alert, Modal, Share } from "react-native";
...
export default function Ticket(){
    ...
    return (
        <View className="flex-1 bg-green-500">
            ...
            <ScrollView 
            className="-m-28 -z-10" contentContainerClassName="px-8 pb-8"
